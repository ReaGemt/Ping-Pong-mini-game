...
while True:
    ...
    if game_state == GAME:
        ...
        display_text(f"Wins: {wins1}", None, 30, WHITE, WIDTH // 4, 100)
        display_text(f"Wins: {wins2}", None, 30, WHITE, 3 * WIDTH // 4, 100)

        all_sprites.draw(screen)

    elif game_state == WIN:
        screen.fill(BLACK)
        display_text("Player 1 Wins the Game!", None, 60, WHITE, WIDTH // 2, HEIGHT // 2)
        display_text("Press Enter to Return to Menu", None, 40, WHITE, WIDTH // 2, HEIGHT // 1.5)

    elif game_state == LOSE:
        screen.fill(BLACK)
        display_text("Player 2 Wins the Game!", None, 60, WHITE, WIDTH // 2, HEIGHT // 2)
        display_text("Press Enter to Return to Menu", None, 40, WHITE, WIDTH // 2, HEIGHT // 1.5)

    elif game_state == ROUND_WIN:
        screen.fill(BLACK)
        display_text(f"Round Over", None, 60, WHITE, WIDTH // 2, HEIGHT // 2)
        display_text("Press 'P' to Continue", None, 40, WHITE, WIDTH // 2, HEIGHT // 1.5)
        ...
        screen.fill(BLACK)
        display_text("Ping Pong", None, 60, WHITE, WIDTH // 2, HEIGHT // 4)
        display_text("Press 1 for Player vs Player", None, 40, WHITE, WIDTH // 2, HEIGHT // 2)
        display_text("Press 2 for Player vs Computer", None, 40, WHITE, WIDTH // 2, HEIGHT // 1.5)

    elif game_state == PAUSE:
        display_text("Paused", None, 60, WHITE, WIDTH // 2, HEIGHT // 2)
        display_text("Press 'P' to Resume", None, 40, WHITE, WIDTH // 2, HEIGHT // 1.5)
